...
const SVGComponent = (props: React.SVGProps<any>) => (
  ...
  >
    ...
    >
      <g transform="rotate(-90 -844.575 -2124.742)" />
      <g transform="rotate(-90 -1211.616 -2345.727)" />
      <g
        style={{
          display: 'inline'
        }}
        transform="rotate(-90 -1762.053 -691.156)"
      />
      <g transform="translate(-1109.491 -2404.16)">
        ...
        >
          <path
            d="m1540.024 2513.363-2.697-4.238h-1.755v4.238h-1.407v-9.943h3.552q.885 0 1.54.192.664.184 1.099.545.442.354.656.863.221.508.221 1.15 0 .456-.147.913-.14.45-.45.833-.31.376-.789.656t-1.15.39l2.949 4.401zm-.206-7.171q0-1.644-2.24-1.644h-2.006v3.464h2.064q.612 0 1.025-.147.42-.148.67-.391.258-.25.369-.582.118-.332.118-.7"
            style={{
              fill: '#fff'
            }}
            aria-label="R"
